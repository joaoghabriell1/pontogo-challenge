...
export type Morph =
  | RegisteredTime
  | RegisteredTimeAggregator
  | RegisteredTimeConnection
  | RegisteredTimeConnectionCreated_At
  | RegisteredTimeConnectionId
  | RegisteredTimeConnectionPublished_At
  | RegisteredTimeConnectionTimeRegistered
  | RegisteredTimeConnectionUpdated_At
  | RegisteredTimeConnectionUser
  | RegisteredTimeGroupBy
  | UploadFile
  ...
  | CreateRegisteredTimePayload
  | CreateRolePayload
  | CreateUserPayload
  | DeleteFilePayload
  | DeleteRegisteredTimePayload
  | DeleteRolePayload
  | DeleteUserPayload
  | UpdateRegisteredTimePayload
  | UpdateRolePayload
  | UpdateUserPayload;
...
export type CreateRegisteredTimeMutation = {
  __typename?: "Mutation";
...
export type RegisteredTimesQuery = {
  __typename?: "Query";
  registeredTimes?: Array<{
    __typename?: "RegisteredTime";
    created_at: any;
    updated_at: any;
    timeRegistered?: any | null;
...
export type GetCurrentUserRegisteredTimesQuery = {
  __typename?: "Query";
  registeredTimes?: Array<{
    __typename?: "RegisteredTime";
    id: string;
...
export const CreateRegisteredTimeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createRegisteredTime" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "createRegisteredTimeInput" },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "registeredTime" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "timeRegistered" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "user" },
  ...
  CreateRegisteredTimeMutation,
  CreateRegisteredTimeMutationVariables
>;
export const RegisteredTimesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "registeredTimes" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  RegisteredTimesQuery,
  RegisteredTimesQueryVariables
>;
export const GetCurrentUserRegisteredTimesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCurrentUserRegisteredTimes" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetCurrentUserRegisteredTimesQuery,
